...
public class Datasource {
    ...
    public static final String QUERY_ALBUMS_BY_ARTIST_START =
            "SELECT " + TABLE_ALBUMS + "libs" + COLUMN_ALBUM_NAME + " FROM " + TABLE_ALBUMS +
                    " INNER JOIN " + TABLE_ARTISTS + " ON " + TABLE_ALBUMS + "." + COLUMN_ALBUM_ARTIST +
                    " = " + TABLE_ARTISTS + "." + COLUMN_ARTIST_ID +
                    " WHERE " + TABLE_ARTISTS + "." + COLUMN_ARTIST_NAME + " = \"";

    public static final String QUERY_ALBUMS_BY_ARTIST_SORT =
            " ORDER BY " + TABLE_ALBUMS + "libs" + COLUMN_ALBUM_NAME + " COLLATE NOCASE ";


    public static final String QUERY_ARTIST_fOR_SONG_START =
            "SELECT " + TABLE_ARTISTS + "libs" + COLUMN_ARTIST_NAME + ", " +
    ...
    public static final String QUERY_ARTIST_FOR_SONG_SORT =
            " ORDER BY " + TABLE_ARTISTS + "libs" + COLUMN_ARTIST_NAME + ", " +
                    TABLE_ALBUMS + "." + COLUMN_ALBUM_NAME + " COLLATE NOCASE ";

    public static final String TABLE_ARTIST_SONG_VIEW = "artist_list";
    public static final String CREATE_ARTIST_FOR_SONG_VIEW = "CREATE VIEW IF NOT EXISTS " +
            TABLE_ARTIST_SONG_VIEW + " AS SELECT " + TABLE_ARTISTS + "libs" + COLUMN_ARTIST_NAME + ", " +
    ...
    public List<Artist> queryArtists(int sortOrder) {
        ...
        // Build query string for querying artists in order
        ...
        // Using try with resources to ensure that close method will be called for both Statement and ResultSet
    ...
    private int insertArtist(String name) throws SQLException {
        ...
        if (result.next()) {
            ...
            // Using execute update to get number of rows affected, instead of boolean indicating state
    ...
    public void insertSong(String title, String artist, String album, int track) {
        try {
            ...
            try {
                ...
                System.out.println("Couldn't roll back changes." + e2.getMessage());
            }
        } finally {
            try {
